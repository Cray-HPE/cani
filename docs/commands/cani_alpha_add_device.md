## cani alpha add device

Add device(s) to the inventory.

### Synopsis

Add one or more devices to the inventory by slug or part number.

```
cani alpha add device <slug-or-part-number> [flags]
```
