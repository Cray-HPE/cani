...
List cables in the inventory with their type and connection status.
...
```
cani alpha show cables [flags]
```

### Options

```
  -h, --help          help for cables
      --unconnected   Show only unconnected cables
```
