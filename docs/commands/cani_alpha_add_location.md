...
Add a location (site, building, floor, room) to the inventory.

```
cani alpha add location [name] [flags]
```
...
```
  -h, --help            help for location
      ...
      --type string     Location type (site, building, floor, room) (default "site")
```
