...
Known errors and solutions specific to the CSM provider.
...
This appears when a NID number in the `ExtraProperties.NID` key is populated with a string instead of an integer.
