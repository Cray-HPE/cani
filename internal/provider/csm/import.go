...
// func applyCANIMetadata(slsHardware *sls_client.Hardware, datastore inventory.Datastore) (bool, error) {
// 	xname := xnames.FromString(slsHardware.Xname)
// 	if xname == nil {
// 		return false, fmt.Errorf("failed to parse xname (%s)", slsHardware.Xname)
// 	}

// 	locationPath, err := FromXname(xname)
// 	if err != nil {
// 		return false, errors.Join(fmt.Errorf("failed to build location path for xname (%v)", xname), err)
// 	}

// 	cHardware, err := datastore.GetAtLocation(locationPath)
// 	if err != nil {
// 		return false, errors.Join(fmt.Errorf("failed to query datastore for %s", locationPath), err)
// 	}

// 	//
// 	// Update SLS Extra Properties
// 	//
// 	// var ep sls_client.CANIMetadata
// 	switch xname.Type() {
// 	case xnametypes.NodeBMCNic:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesBmcNic](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.CDUMgmtSwitch:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesCduMgmtSwitch](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.CabinetPDUNic:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesCabPduNic](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.Cabinet:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesCabinet](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.Chassis:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesChassis](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.ChassisBMC:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesChassisBmc](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.ComputeModule:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesCompmod](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.NodePowerConnector:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesCompmodPowerConnector](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.NodeHsnNic:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesNodeHsnNic](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.HSNConnector:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesHsnConnector](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.MgmtHLSwitch:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesMgmtHlSwitch](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.MgmtSwitch:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesMgmtSwitch](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.MgmtSwitchConnector:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesMgmtSwitchConnector](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.Node:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesNode](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.NodeBMC:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesNcard](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.NodeNic:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesNodeNic](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.RouterBMC:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesRtrBmc](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.RouterBMCNic:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesRtrBmcNic](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	case xnametypes.RouterModule:
// 		ep, err := sls.DecodeExtraProperties[sls_client.HardwareExtraPropertiesRtrmod](*slsHardware)
// 		if err != nil {
// 			return false, err
// 		}
// 	}

// 	// slsHardwareEPRaw, err := slsHardware.DecodeExtraProperties()
// 	// if err != nil {
// 	// 	return false, errors.Join(fmt.Errorf("failed to decode hardware extra properties for (%s)", slsHardware.Xname), err)
// 	// }

// 	// slsHardwareEP, ok := slsHardwareEPRaw.(sls_client.HardwareExtraPropertiesConcrete)
// 	// if !ok {
// 	// 	return false, fmt.Errorf("unexpected provider metadata type (%T) does not implement sls_client.CANIMetadata", slsHardwareEPRaw)
// 	// }

// 	// slsHardwareEP, err := sls.DecodeExtraProperties[T](*slsHardware)
// 	// if err != nil {
// 	// 	return false, errors.Join(fmt.Errorf("failed to decode hardware extra properties for (%s)", slsHardware.Xname), err)
// 	// }

// 	// if slsHardwareEP.GetCaniID() != cHardware.ID.String() {
// 	// 	if len(slsHardwareEP.GetCaniID()) != 0 {
// 	// 		log.Warn().Msgf("Detected CANI hardware ID change from %s to %s for SLS Hardware %s", slsHardwareEP.GetCaniID(), cHardware.ID, slsHardware.Xname)
// 	// 	}

// 	// 	// Update it if it has changed
// 	// 	slsHardwareEP.SetCaniID(cHardware.ID)
// 	// 	slsHardwareEP.SetCaniSlsSchemaVersion("v1alpha1") // TODO make this a enum
// 	// 	slsHardwareEP.SetCaniLastModified(time.Now())

// 	// 	slsHardware.ExtraProperties = slsHardwareEP

// 	// 	log.Debug().Msgf("SLS extra properties changed for %s", slsHardware.Xname)
// 	// 	return true, nil
// 	// }
