...
func (p *Redfish) GetDefaultOptions() map[string]any {
...
func (p *Redfish) GetOptionsStruct() interface{} {
	return &Options{}
}
...
func (p *Redfish) GetImportOptionsStruct() interface{} {
	return map[string]any{}
}

// GetImportDefaults returns default import configuration options.
func (p *Redfish) GetImportDefaults() map[string]any {
	return map[string]any{
		"root": "",
	}
}
...
func (p *Redfish) GetExportOptionsStruct() interface{} {
	return map[string]any{}
}

// GetExportDefaults returns default export configuration options.
func (p *Redfish) GetExportDefaults() map[string]any {
