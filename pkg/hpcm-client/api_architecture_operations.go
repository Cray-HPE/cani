...
/*
ArchitectureOperationsApiService Gets one or more architecture(s)
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identifier Architecture identifier
 * @param optional nil or *ArchitectureOperationsApiGetOpts - Optional Parameters:
...
func (a *ArchitectureOperationsApiService) Get(ctx context.Context, identifier string, localVarOptionals *ArchitectureOperationsApiGetOpts) (Architecture, *http.Response, error) {
	var (
		...
		localVarReturnValue Architecture
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/architectures/{identifier}"
...
/*
ArchitectureOperationsApiService Lists all architectures
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ArchitectureOperationsApiGetAllOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  Fields to display
     * @param "Where" (optional.String) -  Filter resources matching provided where clause
     * @param "AllowsEmpty" (optional.Bool) -  Do not fail when no resource is matched
@return []Architecture
...
func (a *ArchitectureOperationsApiService) GetAll(ctx context.Context, localVarOptionals *ArchitectureOperationsApiGetAllOpts) ([]Architecture, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/architectures"
...
/*
ArchitectureOperationsApiService Gets all attributes of a single architecture
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identifier
 * @param optional nil or *ArchitectureOperationsApiGetAttributesOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  Fields to display
...
func (a *ArchitectureOperationsApiService) GetAttributes(ctx context.Context, identifier string, localVarOptionals *ArchitectureOperationsApiGetAttributesOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/architectures/{identifier}/attributes"
	localVarPath = strings.Replace(localVarPath, "{"+"identifier"+"}", fmt.Sprintf("%v", identifier), -1)
