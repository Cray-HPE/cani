...
/*
CliFromFileApiService Load services state and overwrite current service state
 ...
 * @param optional nil or *CliFromFileApiLoadstatePostOpts - Optional Parameters:
     * @param "SlsDump" (optional.Interface of SlsState) -
...
func (a *CliFromFileApiService) LoadstatePost(ctx context.Context, localVarOptionals *CliFromFileApiLoadstatePostOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/loadstate"
	...
	if localVarOptionals != nil && localVarOptionals.SlsDump.IsSet() {
		localVarFormParams.Add("sls_dump", parameterToString(localVarOptionals.SlsDump.Value(), ""))
	}
...
/*
CliFromFileApiService Update a network object
Update a network object. Parent objects will be created, if possible.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param network The network to look up or alter.
 * @param optional nil or *CliFromFileApiNetworksNetworkPutOpts - Optional Parameters:
...
/*
CliFromFileApiService Create a new network
Create a new network. Must include all fields at the time of upload.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CliFromFileApiNetworksPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Network) -
