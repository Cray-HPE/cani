...
/*
DumpstateApiService Retrieve a dump of current service state
...
func (a *DumpstateApiService) DumpstateGet(ctx context.Context) (SlsState, *http.Response, error) {
	var (
		...
		localVarReturnValue SlsState
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dumpstate"
...
/*
DumpstateApiService Load services state and overwrite current service state
\&quot;Load services state and overwrite current service state. The format of the upload is implementation specific.\&quot;
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DumpstateApiLoadstatePostOpts - Optional Parameters:
