...
/*
ServiceInfoApiService Retrieve all valid values for use with the &#x27;arch&#x27; parameter
Retrieve all valid values for use with the &#x27;arch&#x27; (component architecture) parameter.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100ArchArray
*/
func (a *ServiceInfoApiService) DoArchValuesGet(ctx context.Context) (Values100ArchArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100ArchArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values/arch"
...
/*
ServiceInfoApiService Retrieve all valid values for use with the &#x27;class&#x27; parameter
Retrieve all valid values for use with the &#x27;class&#x27; (hardware class) parameter.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100ClassArray
*/
func (a *ServiceInfoApiService) DoClassValuesGet(ctx context.Context) (Values100ClassArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100ClassArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values/class"
...
/*
ServiceInfoApiService Retrieve all valid values for use with the &#x27;flag&#x27; parameter
Retrieve all valid values for use with the &#x27;flag&#x27; (component flag) parameter.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100FlagArray
*/
func (a *ServiceInfoApiService) DoFlagValuesGet(ctx context.Context) (Values100FlagArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100FlagArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values/flag"
...
/*
ServiceInfoApiService Kubernetes liveness endpoint to monitor service health
The &#x60;liveness&#x60; resource works in conjunction with the Kubernetes liveness probe to determine when the service is no longer responding to requests.  Too many failures of the liveness probe will result in the service being shut down and restarted.  This is primarily an endpoint for the automated Kubernetes system.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
*/
func (a *ServiceInfoApiService) DoLivenessGet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/liveness"
...
/*
ServiceInfoApiService Retrieve all valid values for use with the &#x27;nettype&#x27; parameter
Retrieve all valid values for use with the &#x27;nettype&#x27; (component network type) parameter.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100NetTypeArray
*/
func (a *ServiceInfoApiService) DoNetTypeValuesGet(ctx context.Context) (Values100NetTypeArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100NetTypeArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values/nettype"
...
/*
ServiceInfoApiService Kubernetes readiness endpoint to monitor service health
...
@return Response100
*/
func (a *ServiceInfoApiService) DoReadyGet(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/ready"
...
/*
ServiceInfoApiService Retrieve all valid values for use with the &#x27;role&#x27; parameter
Retrieve all valid values for use with the &#x27;role&#x27; (component role) parameter.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100RoleArray
*/
func (a *ServiceInfoApiService) DoRoleValuesGet(ctx context.Context) (Values100RoleArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100RoleArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values/role"
...
/*
ServiceInfoApiService Retrieve all valid values for use with the &#x27;state&#x27; parameter
Retrieve all valid values for use with the &#x27;state&#x27; (component state) parameter.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100StateArray
*/
func (a *ServiceInfoApiService) DoStateValuesGet(ctx context.Context) (Values100StateArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100StateArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values/state"
...
/*
ServiceInfoApiService Retrieve all valid values for use with the &#x27;subrole&#x27; parameter
Retrieve all valid values for use with the &#x27;subrole&#x27; (component subrole) parameter.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100SubRoleArray
*/
func (a *ServiceInfoApiService) DoSubRoleValuesGet(ctx context.Context) (Values100SubRoleArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100SubRoleArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values/subrole"
...
/*
ServiceInfoApiService Retrieve all valid values for use with the &#x27;type&#x27; parameter
Retrieve all valid values for use with the &#x27;type&#x27; (component HMSType) parameter.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100TypeArray
*/
func (a *ServiceInfoApiService) DoTypeValuesGet(ctx context.Context) (Values100TypeArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100TypeArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values/type"
...
/*
ServiceInfoApiService Retrieve all valid values for use as parameters
Retrieve all valid values for use as parameters.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Values100Values
*/
func (a *ServiceInfoApiService) DoValuesGet(ctx context.Context) (Values100Values, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Values100Values
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/values"
