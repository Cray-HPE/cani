...
type CliDangerThisWillDeleteAllHistoryForThisFRUContinueApiService service

/*
CliDangerThisWillDeleteAllHistoryForThisFRUContinueApiService Delete history for the HWInventoryByFRU entry with FRU identifier {fruid}
...
@return Response100
*/
func (a *CliDangerThisWillDeleteAllHistoryForThisFRUContinueApiService) DoHWInvHistByFRUDelete(ctx context.Context, fruid string) (Response100, *http.Response, error) {
	var (
