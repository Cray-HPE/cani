...
type NodeMapApiService service

/*
NodeMapApiService Delete NodeMap with ID {xname}
Delete NodeMap entry for a specific node {xname}.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of NodeMap record to delete.

@return Response100
*/
func (a *NodeMapApiService) DoNodeMapDelete(ctx context.Context, xname string) (Response100, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Defaults/NodeMaps/{xname}"
...
/*
NodeMapApiService Retrieve NodeMap at {xname}
Retrieve NodeMap, i.e. defaults NID/Role/etc. for node located at physical location {xname}.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of NodeMap record to return.

@return NodeMap100NodeMap
*/
func (a *NodeMapApiService) DoNodeMapGet(ctx context.Context, xname string) (NodeMap100NodeMap, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue NodeMap100NodeMap
	)
...
/*
NodeMapApiService Create or Modify NodeMaps
...
@return Response100
*/
func (a *NodeMapApiService) DoNodeMapPost(ctx context.Context, body NodeMapArrayNodeMapArray) (Response100, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Defaults/NodeMaps"
...
/*
NodeMapApiService Update definition for NodeMap ID {xname}
Update or create an entry for an individual node xname using PUT. Note the following points: * If the PUT operation contains an xname that already exists, the entry will be overwritten with the new entry (i.e. new NID, Role (if given), etc.). * The same NID cannot be used for more than one xname. If such a duplicate would be created, the operation will fail. * If the node has already been discovered for the first time (that is, it exists in /hsm/v2/State/Components and already has a previous/default NID), modifying the NodeMap entry will not automatically reassign the current NID.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of NodeMap record to create or update.

@return NodeMap100PostNodeMap
*/
func (a *NodeMapApiService) DoNodeMapPut(ctx context.Context, body NodeMap100NodeMap, xname string) (NodeMap100PostNodeMap, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue NodeMap100PostNodeMap
	)
...
/*
NodeMapApiService Delete all NodeMap entities
Delete all entries in the NodeMaps collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *NodeMapApiService) DoNodeMapsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
NodeMapApiService Retrieve all NodeMaps, returning NodeMapArray
Retrieve all Node map entries as a named array, or an empty array if the collection is empty.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return NodeMapArrayNodeMapArray
*/
func (a *NodeMapApiService) DoNodeMapsGet(ctx context.Context) (NodeMapArrayNodeMapArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue NodeMapArrayNodeMapArray
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v NodeMapArrayNodeMapArray
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
