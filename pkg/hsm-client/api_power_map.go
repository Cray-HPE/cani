...
type PowerMapApiService service

/*
PowerMapApiService Delete PowerMap with ID {xname}
Delete PowerMap entry for a specific component {xname}.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of PowerMap record to delete.

@return Response100
*/
func (a *PowerMapApiService) DoPowerMapDelete(ctx context.Context, xname string) (Response100, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sysinfo/powermaps/{xname}"
...
/*
PowerMapApiService Retrieve PowerMap at {xname}
Retrieve PowerMap for a component located at physical location {xname}.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of PowerMap record to return.

@return PowerMap100PowerMap
*/
func (a *PowerMapApiService) DoPowerMapGet(ctx context.Context, xname string) (PowerMap100PowerMap, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PowerMap100PowerMap
	)
...
/*
PowerMapApiService Update definition for PowerMap ID {xname}
Update or create an entry for an individual component xname using PUT. If the PUT operation contains an xname that already exists, the entry will be overwritten with the new entry.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of PowerMap record to create or update.

@return Response100
*/
func (a *PowerMapApiService) DoPowerMapPut(ctx context.Context, body PowerMap100PowerMap, xname string) (Response100, *http.Response, error) {
	var (
...
/*
PowerMapApiService Delete all PowerMap entities
Delete all entries in the PowerMaps collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *PowerMapApiService) DoPowerMapsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sysinfo/powermaps"
...
/*
PowerMapApiService Retrieve all PowerMaps, returning PowerMapArray
Retrieve all power map entries as a named array, or an empty array if the collection is empty.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []PowerMap100PostPowerMap
*/
func (a *PowerMapApiService) DoPowerMapsGet(ctx context.Context) ([]PowerMap100PostPowerMap, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []PowerMap100PostPowerMap
	)
...
/*
PowerMapApiService Create or Modify PowerMaps
...
@return Response100
*/
func (a *PowerMapApiService) DoPowerMapsPost(ctx context.Context, body []PowerMap100PostPowerMap) (Response100, *http.Response, error) {
	var (
