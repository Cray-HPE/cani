...
type ServiceEndpointApiService service

/*
ServiceEndpointApiService Delete the {service} ServiceEndpoint managed by {xname}
Delete the {service} ServiceEndpoint managed by {xname}
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param service The Redfish service type of the ServiceEndpoint record to delete.
  - @param xname The locational xname of the RedfishEndpoint that manages the ServiceEndpoint record to delete.

@return Response100
*/
func (a *ServiceEndpointApiService) DoServiceEndpointDelete(ctx context.Context, service string, xname string) (Response100, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Inventory/ServiceEndpoints/{service}/RedfishEndpoints/{xname}"
...
/*
ServiceEndpointApiService Retrieve the ServiceEndpoint of a {service} managed by {xname}
Retrieve the ServiceEndpoint for a Redfish service that is managed by xname.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param service The Redfish service type of the ServiceEndpoint record to return.
  - @param xname The locational xname of the RedfishEndpoint that manages the ServiceEndpoint record to return.

@return ServiceEndpoint100ServiceEndpoint
*/
func (a *ServiceEndpointApiService) DoServiceEndpointGet(ctx context.Context, service string, xname string) (ServiceEndpoint100ServiceEndpoint, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ServiceEndpoint100ServiceEndpoint
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ServiceEndpoint100ServiceEndpoint
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ServiceEndpointApiService Delete all ServiceEndpoints
Delete all entries in the ServiceEndpoint collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *ServiceEndpointApiService) DoServiceEndpointsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Inventory/ServiceEndpoints"
...
/*
ServiceEndpointApiService Retrieve all ServiceEndpoints of a {service}
Retrieve all ServiceEndpoint records for the Redfish service.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param service The Redfish service type of the ServiceEndpoint records to return.
 * @param optional nil or *ServiceEndpointApiDoServiceEndpointsGetOpts - Optional Parameters:
     * @param "RedfishEp" (optional.String) -  Retrieve all ServiceEndpoints of type {service} managed by the parent Redfish EP. Can be repeated to select groups of endpoints.
@return ServiceEndpointArrayServiceEndpointArray
*/

type ServiceEndpointApiDoServiceEndpointsGetOpts struct {
	RedfishEp optional.String
}

func (a *ServiceEndpointApiService) DoServiceEndpointsGet(ctx context.Context, service string, localVarOptionals *ServiceEndpointApiDoServiceEndpointsGetOpts) (ServiceEndpointArrayServiceEndpointArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ServiceEndpointArrayServiceEndpointArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Inventory/ServiceEndpoints/{service}"
	localVarPath = strings.Replace(localVarPath, "{"+"service"+"}", fmt.Sprintf("%v", service), -1)
	...
	if localVarOptionals != nil && localVarOptionals.RedfishEp.IsSet() {
		localVarQueryParams.Add("redfish_ep", parameterToString(localVarOptionals.RedfishEp.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ServiceEndpointArrayServiceEndpointArray
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ServiceEndpointApiService Retrieve ServiceEndpoints Collection
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ServiceEndpointApiDoServiceEndpointsGetAllOpts - Optional Parameters:
     * @param "RedfishEp" (optional.String) -  Retrieve all ServiceEndpoints managed by the parent Redfish EP. Can be repeated to select groups of endpoints.
     * @param "Service" (optional.String) -  Retrieve all ServiceEndpoints of the given Redfish service.
@return ServiceEndpointArrayServiceEndpointArray
*/

type ServiceEndpointApiDoServiceEndpointsGetAllOpts struct {
	RedfishEp optional.String
	Service   optional.String
}

func (a *ServiceEndpointApiService) DoServiceEndpointsGetAll(ctx context.Context, localVarOptionals *ServiceEndpointApiDoServiceEndpointsGetAllOpts) (ServiceEndpointArrayServiceEndpointArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
