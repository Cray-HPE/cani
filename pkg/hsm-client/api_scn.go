...
type SCNApiService service

/*
SCNApiService Delete a state change notification subscription
Delete a state change notification subscription.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id This is the ID associated with the subscription that was generated at its creation.
*/
func (a *SCNApiService) DoDeleteSCNSubscription(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Subscriptions/SCN/{id}"
...
/*
SCNApiService Delete all state change notification subscriptions
Delete all subscriptions.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
*/
func (a *SCNApiService) DoDeleteSCNSubscriptionsAll(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Subscriptions/SCN"
...
/*
SCNApiService Retrieve a currently-held state change notification subscription
Return the information on a currently held state change notification subscription
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id This is the ID associated with the subscription that was generated at its creation.

@return SubscriptionsScnPostSubscription
*/
func (a *SCNApiService) DoGetSCNSubscription(ctx context.Context, id string) (SubscriptionsScnPostSubscription, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SubscriptionsScnPostSubscription
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SubscriptionsScnPostSubscription
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
...
/*
SCNApiService Retrieve currently-held state change notification subscriptions
Retrieve all information on currently held state change notification subscriptions.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return SubscriptionsScnSubscriptionArray
*/
func (a *SCNApiService) DoGetSCNSubscriptionsAll(ctx context.Context) (SubscriptionsScnSubscriptionArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SubscriptionsScnSubscriptionArray
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SubscriptionsScnSubscriptionArray
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
SCNApiService Update a subscription for state change notifications
Update a subscription for state change notifications to add or remove triggers.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param id This is the ID associated with the subscription that was generated at its creation.
*/
func (a *SCNApiService) DoPatchSCNSubscription(ctx context.Context, body SubscriptionsScnPatchSubscription, id string) (*http.Response, error) {
	var (
...
/*
SCNApiService Create a subscription for state change notifications
...
@return SubscriptionsScnSubscriptionArrayItem100
*/
func (a *SCNApiService) DoPostSCNSubscription(ctx context.Context, body SubscriptionsScnPostSubscription) (SubscriptionsScnSubscriptionArrayItem100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SubscriptionsScnSubscriptionArrayItem100
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SubscriptionsScnSubscriptionArrayItem100
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
Update an existing state change notification subscription in whole. This will overwrite the specified subscription.
  ...
  - @param id This is the ID associated with the subscription that was generated at its creation.
*/
func (a *SCNApiService) DoPutSCNSubscription(ctx context.Context, body SubscriptionsScnPostSubscription, id string) (*http.Response, error) {
	var (
