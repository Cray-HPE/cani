...
type HWInventoryByFRUApiService service

/*
HWInventoryByFRUApiService Delete HWInventoryByFRU entry with FRU identifier {fruid}
Delete an entry in the HWInventoryByFRU collection. Note that this does not delete the associated HWInventoryByLocation entry if the FRU is currently residing in the system. In fact, if the FRU ID is associated with a HWInventoryByLocation currently, the deletion will fail.
  ...
  - @param fruid Locational xname of HWInventoryByFRU record to delete.

@return Response100
*/
func (a *HWInventoryByFRUApiService) DoHWInvByFRUDelete(ctx context.Context, fruid string) (Response100, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Inventory/HardwareByFRU/{fruid}"
...
/*
HWInventoryByFRUApiService Delete all HWInventoryByFRU entries
...
@return Response100
*/
func (a *HWInventoryByFRUApiService) DoHWInvByFRUDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Inventory/HardwareByFRU"
...
/*
HWInventoryByFRUApiService Retrieve HWInventoryByFRU for {fruid}
...
@return HwInventory100HwInventoryByFru
*/
func (a *HWInventoryByFRUApiService) DoHWInvByFRUGet(ctx context.Context, fruid string) (HwInventory100HwInventoryByFru, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue HwInventory100HwInventoryByFru
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v HwInventory100HwInventoryByFru
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
HWInventoryByFRUApiService Retrieve all HWInventoryByFRU entries in a flat array
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *HWInventoryByFRUApiDoHWInvByFRUGetAllOpts - Optional Parameters:
     * @param "Fruid" (optional.String) -  Retrieve HWInventoryByFRU entries with the given FRU ID.
     ...
     * @param "Manufacturer" (optional.String) -  Retrieve HWInventoryByFRU entries with the given Manufacturer.
     * @param "Partnumber" (optional.String) -  Retrieve HWInventoryByFRU entries with the given part number.
     * @param "Serialnumber" (optional.String) -  Retrieve HWInventoryByFRU entries with the given serial number.
@return []HwInventory100HwInventoryByFru
*/

type HWInventoryByFRUApiDoHWInvByFRUGetAllOpts struct {
...
func (a *HWInventoryByFRUApiService) DoHWInvByFRUGetAll(ctx context.Context, localVarOptionals *HWInventoryByFRUApiDoHWInvByFRUGetAllOpts) ([]HwInventory100HwInventoryByFru, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
