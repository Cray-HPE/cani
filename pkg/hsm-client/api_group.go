...
/*
GroupApiService Delete existing group with {group_label}
Delete the given group with {group_label}. Any members previously in the group will no longer have the deleted group label associated with them.
  ...
  - @param groupLabel Label (i.e. name) of the group to delete.

@return Response100
*/
func (a *GroupApiService) DoGroupDelete(ctx context.Context, groupLabel string) (Response100, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/groups/{group_label}"
	localVarPath = strings.Replace(localVarPath, "{"+"group_label"+"}", fmt.Sprintf("%v", groupLabel), -1)
...
/*
GroupApiService Retrieve existing group {group_label}
Retrieve the group which was created with the given {group_label}.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupLabel Label name of the group to return.
 * @param optional nil or *GroupApiDoGroupGetOpts - Optional Parameters:
     * @param "Partition" (optional.String) -  AND the members set by the given partition name (p#.#).  NULL will return the group members not in ANY partition.
@return Group100
*/

type GroupApiDoGroupGetOpts struct {
	Partition optional.String
}

func (a *GroupApiService) DoGroupGet(ctx context.Context, groupLabel string, localVarOptionals *GroupApiDoGroupGetOpts) (Group100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Group100
	)
...
/*
GroupApiService Retrieve all existing group labels
Retrieve a string array of all group labels (i.e. group names) that currently exist in HSM.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []string
*/
func (a *GroupApiService) DoGroupLabelsGet(ctx context.Context) ([]string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/groups/labels"
...
/*
GroupApiService Delete member from existing group
Delete component {xname_id} from the members of group {group_label}.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param groupLabel Specifies an existing group {group_label} to remove the member from.
  - @param xnameId Member of {group_label} to remove.

@return Response100
*/
func (a *GroupApiService) DoGroupMemberDelete(ctx context.Context, groupLabel string, xnameId string) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/groups/{group_label}/members/{xname_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"group_label"+"}", fmt.Sprintf("%v", groupLabel), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"xname_id"+"}", fmt.Sprintf("%v", xnameId), -1)
...
/*
GroupApiService Retrieve all members of existing group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupLabel Specifies an existing group {group_label} to query the members of.
 * @param optional nil or *GroupApiDoGroupMembersGetOpts - Optional Parameters:
     * @param "Partition" (optional.String) -  AND the members set by the given partition name (p#.#).  NULL will return the group members not in ANY partition.
@return Members100
*/

type GroupApiDoGroupMembersGetOpts struct {
	Partition optional.String
}

func (a *GroupApiService) DoGroupMembersGet(ctx context.Context, groupLabel string, localVarOptionals *GroupApiDoGroupMembersGetOpts) (Members100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Members100
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/groups/{group_label}/members"
	localVarPath = strings.Replace(localVarPath, "{"+"group_label"+"}", fmt.Sprintf("%v", groupLabel), -1)
...
/*
GroupApiService Create new member of existing group (via POST)
Create a new member of group {group_label} with the component xname ID provided in the payload. New member should not already exist in the given group.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param groupLabel Specifies an existing group {group_label} to add the new member to.

@return []ResourceUri100
*/
func (a *GroupApiService) DoGroupMembersPost(ctx context.Context, body MemberId, groupLabel string) ([]ResourceUri100, *http.Response, error) {
	var (
...
/*
GroupApiService Update metadata for existing group {group_label}
To update the tags array and/or description, a PATCH operation can be used.  Omitted fields are not updated. This cannot be used to completely replace the members list. Rather, individual members can be removed or added with the POST/DELETE {group_label}/members API below.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param groupLabel Label (i.e. name) of the group to update.
*/
func (a *GroupApiService) DoGroupPatch(ctx context.Context, body Group100Patch, groupLabel string) (*http.Response, error) {
	var (
...
/*
GroupApiService Retrieve all existing groups
Retrieve all groups that currently exist, optionally filtering the set, returning an array of groups.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GroupApiDoGroupsGetOpts - Optional Parameters:
     * @param "Group" (optional.String) -  Retrieve the group with the provided group label. Can be repeated to select multiple groups.
     * @param "Tag" (optional.String) -  Retrieve all groups associated with the given free-form tag from the tags field.
@return []Group100
*/

type GroupApiDoGroupsGetOpts struct {
	Group optional.String
	Tag   optional.String
}

func (a *GroupApiService) DoGroupsGet(ctx context.Context, localVarOptionals *GroupApiDoGroupsGetOpts) ([]Group100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return []ResourceUri100
*/
func (a *GroupApiService) DoGroupsPost(ctx context.Context, body Group100) ([]ResourceUri100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
