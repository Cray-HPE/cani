...
type CliDangerThisWillDeleteAllFRUsForHSMContinueApiService service

/*
CliDangerThisWillDeleteAllFRUsForHSMContinueApiService Delete all HWInventoryByFRU entries
...
@return Response100
*/
func (a *CliDangerThisWillDeleteAllFRUsForHSMContinueApiService) DoHWInvByFRUDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
