...
**RouterModuleLocationInfo** | [***HwInventory100RedfishChassisLocationInfo**](HWInventory.1.0.0_RedfishChassisLocationInfo.md) |  | [optional] [default to null]
**HSNBoards** | [**[]HwInvByLocHsnBoard**](HWInvByLocHSNBoard.md) | Embedded HSNBoard HWInv object array representing subcomponents of that type (if query is hierarchical). | [optional] [default to null]
