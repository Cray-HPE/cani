...
**ChassisLocationInfo** | [***HwInventory100RedfishChassisLocationInfo**](HWInventory.1.0.0_RedfishChassisLocationInfo.md) |  | [optional] [default to null]
**ComputeModules** | [**[]HwInvByLocComputeModule**](HWInvByLocComputeModule.md) | Embedded ComputeModule HWInv object array representing subcomponents of that type (if query is hierarchical). | [optional] [default to null]
**RouterModules** | [**[]HwInvByLocRouterModule**](HWInvByLocRouterModule.md) | Embedded RouterModule HWInv object array representing subcomponents of that type (if query is hierarchical). | [optional] [default to null]
