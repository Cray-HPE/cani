...
**CabinetLocationInfo** | [***HwInventory100RedfishChassisLocationInfo**](HWInventory.1.0.0_RedfishChassisLocationInfo.md) |  | [optional] [default to null]
**Chassis** | [**[]HwInvByLocChassis**](HWInvByLocChassis.md) | Embedded chassis HWInv object array representing subcomponents (if query is hierarchical). | [optional] [default to null]
