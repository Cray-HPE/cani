...
type CliDangerThisWillDeleteAllComponentEthernetInterfacesContinueApiService service

/*
CliDangerThisWillDeleteAllComponentEthernetInterfacesContinueApiService Clear the component Ethernet interface collection.
Delete all component Ethernet interface entries.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *CliDangerThisWillDeleteAllComponentEthernetInterfacesContinueApiService) DoCompEthInterfaceDeleteAllV2(ctx context.Context) (Response100, *http.Response, error) {
	var (
