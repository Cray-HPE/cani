...
type CliDangerThisWillDeleteAllHistoryForThisXnameContinueApiService service

/*
CliDangerThisWillDeleteAllHistoryForThisXnameContinueApiService DELETE history for the HWInventoryByLocation entry with ID (location) {xname}
...
@return Response100
*/
func (a *CliDangerThisWillDeleteAllHistoryForThisXnameContinueApiService) DoHWInvHistByLocationDelete(ctx context.Context, xname string) (Response100, *http.Response, error) {
	var (
