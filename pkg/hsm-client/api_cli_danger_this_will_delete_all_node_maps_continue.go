...
type CliDangerThisWillDeleteAllNodeMapsContinueApiService service

/*
CliDangerThisWillDeleteAllNodeMapsContinueApiService Delete all NodeMap entities
Delete all entries in the NodeMaps collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *CliDangerThisWillDeleteAllNodeMapsContinueApiService) DoNodeMapsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
