...
type LockingApiService service

/*
LockingApiService Disables the ability to create a reservation on components.
Disables the ability to create a reservation on components, deletes any existing reservations. Does not change lock state. Attempting to disable an already-disabled component will not result in an error.
  ...
  - @param body List of xnames to disable.

@return XnameResponse100
*/
func (a *LockingApiService) LocksDisablePost(ctx context.Context, body AdminLock100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue XnameResponse100
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/disable"
...
/*
LockingApiService Locks components.
Using a component create a lock.  Cannot be locked if already locked, or if there is a current reservation.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of xnames to lock.

@return XnameResponse100
*/
func (a *LockingApiService) LocksLockPost(ctx context.Context, body AdminLock100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/lock"
...
/*
LockingApiService Repair components lock and reservation ability.
Repairs the disabled status of an xname allowing new reservations to be created.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of xnames to repair.

@return XnameResponse100
*/
func (a *LockingApiService) LocksRepairPost(ctx context.Context, body AdminLock100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/repair"
...
/*
LockingApiService Create reservations
Creates reservations on a set of xnames of infinite duration.  Component must be locked to create a reservation.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of components to create reservations. A &#x60;rigid&#x60; processing model will result in the entire set of xnames not having reservations created if an xname doesn&#x27;t exist, or isn&#x27;t locked, or if already reserved. A &#x60;flexible&#x60; processing model will perform all actions possible.

@return AdminReservationCreateResponse100
*/
func (a *LockingApiService) LocksReservationsPost(ctx context.Context, body AdminReservationCreate100) (AdminReservationCreateResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AdminReservationCreateResponse100
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/reservations"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 202 {
			var v AdminReservationCreateResponse100
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
LockingApiService Releases existing reservations.
Given a list of {xname &amp; reservation key}, releases the associated reservations.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of {xname and reservation key} to release reservations. A &#x60;rigid&#x60; processing model will result in the entire set of xnames not having their reservation released if an xname doesn&#x27;t exist, or isn&#x27;t reserved. A &#x60;flexible&#x60; processing model will perform all actions possible.

@return XnameResponse100
*/
func (a *LockingApiService) LocksReservationsReleasePost(ctx context.Context, body ReservedKeys100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/reservations/release"
...
/*
LockingApiService Forcibly deletes existing reservations.
Given a list of components, forcibly deletes any existing reservation. Does not change lock state; does not disable the reservation ability of the component. An empty set of xnames will delete reservations on all xnames. This functionality should be used sparingly, the normal flow should be to release reservations, versus removing them.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of xnames to remove reservations. A &#x60;rigid&#x60; processing model will result in the entire set of xnames not having their reservation removed if an xname doesn&#x27;t exist, or isn&#x27;t reserved. A &#x60;flexible&#x60; processing model will perform all actions possible.

@return XnameResponse100
*/
func (a *LockingApiService) LocksReservationsRemovePost(ctx context.Context, body AdminReservationRemove100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/reservations/remove"
...
/*
LockingApiService Check the validity of reservations.
Using xname + reservation key check on the validity of reservations.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of components &amp; deputy keys to check on validity of reservations.

@return ServiceReservationCheckResponse100
*/
func (a *LockingApiService) LocksServiceReservationsCheckPost(ctx context.Context, body DeputyKeys100) (ServiceReservationCheckResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ServiceReservationCheckResponse100
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/service/reservations/check"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 202 {
			var v ServiceReservationCheckResponse100
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
@return ServiceReservationCreateResponse100
*/
func (a *LockingApiService) LocksServiceReservationsPost(ctx context.Context, body ServiceReservationCreate100) (ServiceReservationCreateResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ServiceReservationCreateResponse100
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/service/reservations"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 202 {
			var v ServiceReservationCreateResponse100
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
@return XnameResponse100
*/
func (a *LockingApiService) LocksServiceReservationsReleasePost(ctx context.Context, body ReservedKeys100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/service/reservations/release"
...
/*
LockingApiService Renew existing reservations.
Given a list of {xname &amp; reservation key}, renews the associated reservations.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of {xname and reservation key} to renew reservations. A &#x60;rigid&#x60; processing model will result in the entire set of xnames not having their reservation renewed if an xname doesn&#x27;t exist, or isn&#x27;t reserved. A &#x60;flexible&#x60; processing model will perform all actions possible.

@return XnameResponse100
*/
func (a *LockingApiService) LocksServiceReservationsRenewPost(ctx context.Context, body ReservedKeysWithRenewal100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/service/reservations/renew"
...
/*
LockingApiService Retrieve lock status for all components or a filtered subset of components.
Retrieve the status of all component locks and/or reservations. Results can be filtered by query parameters.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LockingApiLocksStatusGetOpts - Optional Parameters:
     ...
     * @param "Locked" (optional.Bool) -  Return components based on the &#x27;Locked&#x27; field of their lock status.
     * @param "Reserved" (optional.Bool) -  Return components based on the &#x27;Reserved&#x27; field of their lock status.
     * @param "ReservationDisabled" (optional.Bool) -  Return components based on the &#x27;ReservationDisabled&#x27; field of their lock status.
@return AdminStatusCheckResponse100
*/

type LockingApiLocksStatusGetOpts struct {
	...
	ReservationDisabled optional.Bool
}

func (a *LockingApiService) LocksStatusGet(ctx context.Context, localVarOptionals *LockingApiLocksStatusGetOpts) (AdminStatusCheckResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AdminStatusCheckResponse100
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/status"
	...
	if localVarOptionals != nil && localVarOptionals.ReservationDisabled.IsSet() {
		localVarQueryParams.Add("reservationDisabled", parameterToString(localVarOptionals.ReservationDisabled.Value(), ""))
	}
	// to determine the Content-Type header
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdminStatusCheckResponse100
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
LockingApiService Retrieve lock status for component IDs.
Using component ID retrieve the status of any lock and/or reservation.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of components to retrieve status.

@return AdminStatusCheckResponse100
*/
func (a *LockingApiService) LocksStatusPost(ctx context.Context, body Xnames) (AdminStatusCheckResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
LockingApiService Unlocks components.
Using a component unlock a lock.  Cannot be unlocked if already unlocked.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body List of xnames to unlock.

@return XnameResponse100
*/
func (a *LockingApiService) LocksUnlockPost(ctx context.Context, body AdminLock100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/locks/unlock"
