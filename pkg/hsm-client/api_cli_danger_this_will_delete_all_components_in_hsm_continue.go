...
type CliDangerThisWillDeleteAllComponentsInHSMContinueApiService service

/*
CliDangerThisWillDeleteAllComponentsInHSMContinueApiService Delete all components
Delete all entries in the components collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *CliDangerThisWillDeleteAllComponentsInHSMContinueApiService) DoComponentsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
