...
type AdminReservationsApiService service

/*
AdminReservationsApiService Create reservations
...
*/
func (a *AdminReservationsApiService) LocksReservationsPost(ctx context.Context, body AdminReservationCreate100) (AdminReservationCreateResponse100, *http.Response, error) {
	var (
...
/*
AdminReservationsApiService Releases existing reservations.
...
*/
func (a *AdminReservationsApiService) LocksReservationsReleasePost(ctx context.Context, body ReservedKeys100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
AdminReservationsApiService Forcibly deletes existing reservations.
...
@return XnameResponse100
*/
func (a *AdminReservationsApiService) LocksReservationsRemovePost(ctx context.Context, body AdminReservationRemove100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
