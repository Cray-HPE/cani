...
type CliDangerThisWillDeleteAllHardwareHistoryContinueApiService service

/*
CliDangerThisWillDeleteAllHardwareHistoryContinueApiService Clear the HWInventory history.
...
@return Response100
*/
func (a *CliDangerThisWillDeleteAllHardwareHistoryContinueApiService) DoHWInvHistByLocationDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
