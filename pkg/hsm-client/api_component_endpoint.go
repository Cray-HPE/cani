...
/*
ComponentEndpointApiService Delete ComponentEndpoint with ID {xname}
Delete ComponentEndpoint for a specific xname.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of ComponentEndpoint record to delete.

@return Response100
*/
func (a *ComponentEndpointApiService) DoComponentEndpointDelete(ctx context.Context, xname string) (Response100, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Inventory/ComponentEndpoints/{xname}"
...
/*
ComponentEndpointApiService Retrieve ComponentEndpoint at {xname}
Retrieve ComponentEndpoint record for a specific xname.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of ComponentEndpoint record to return.

@return ComponentEndpoint100ComponentEndpoint
*/
func (a *ComponentEndpointApiService) DoComponentEndpointGet(ctx context.Context, xname string) (ComponentEndpoint100ComponentEndpoint, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ComponentEndpoint100ComponentEndpoint
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ComponentEndpoint100ComponentEndpoint
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ComponentEndpointApiService Delete all ComponentEndpoints
Delete all entries in the ComponentEndpoint collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *ComponentEndpointApiService) DoComponentEndpointsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Inventory/ComponentEndpoints"
...
/*
ComponentEndpointApiService Retrieve ComponentEndpoints Collection
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ComponentEndpointApiDoComponentEndpointsGetOpts - Optional Parameters:
     ...
     * @param "RedfishEp" (optional.String) -  Retrieve all ComponentEndpoints managed by the parent Redfish EP.
     ...
     * @param "RedfishType" (optional.String) -  Retrieve all ComponentEndpoints with the given Redfish type.
@return ComponentEndpointArrayComponentEndpointArray
*/

type ComponentEndpointApiDoComponentEndpointsGetOpts struct {
	Id          optional.String
	RedfishEp   optional.String
	Type_       optional.String
	RedfishType optional.String
}

func (a *ComponentEndpointApiService) DoComponentEndpointsGet(ctx context.Context, localVarOptionals *ComponentEndpointApiDoComponentEndpointsGetOpts) (ComponentEndpointArrayComponentEndpointArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ComponentEndpointArrayComponentEndpointArray
	)
	...
	if localVarOptionals != nil && localVarOptionals.RedfishType.IsSet() {
		localVarQueryParams.Add("redfish_type", parameterToString(localVarOptionals.RedfishType.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ComponentEndpointArrayComponentEndpointArray
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
