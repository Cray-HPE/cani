...
type HWInventoryByLocationApiService service

/*
HWInventoryByLocationApiService DELETE HWInventoryByLocation entry with ID (location) {xname}
Delete HWInventoryByLocation entry for a specific xname.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of HWInventoryByLocation record to delete.

@return Response100
*/
func (a *HWInventoryByLocationApiService) DoHWInvByLocationDelete(ctx context.Context, xname string) (Response100, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Inventory/Hardware/{xname}"
...
/*
HWInventoryByLocationApiService Delete all HWInventoryByLocation entries
...
@return Response100
*/
func (a *HWInventoryByLocationApiService) DoHWInvByLocationDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Inventory/Hardware"
...
/*
HWInventoryByLocationApiService Retrieve HWInventoryByLocation entry at {xname}
Retrieve HWInventoryByLocation entries for a specific xname.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of hardware inventory record to return.

@return HwInventory100HwInventoryByLocation
*/
func (a *HWInventoryByLocationApiService) DoHWInvByLocationGet(ctx context.Context, xname string) (HwInventory100HwInventoryByLocation, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue HwInventory100HwInventoryByLocation
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v HwInventory100HwInventoryByLocation
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
HWInventoryByLocationApiService Retrieve all HWInventoryByLocation entries in array
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *HWInventoryByLocationApiDoHWInvByLocationGetAllOpts - Optional Parameters:
     ...
     * @param "Manufacturer" (optional.String) -  Retrieve HWInventoryByLocation entries with the given Manufacturer.
     * @param "Partnumber" (optional.String) -  Retrieve HWInventoryByLocation entries with the given part number.
     * @param "Serialnumber" (optional.String) -  Retrieve HWInventoryByLocation entries with the given serial number.
     * @param "Fruid" (optional.String) -  Retrieve HWInventoryByLocation entries with the given FRU ID.
@return []HwInventory100HwInventoryByLocation
*/

type HWInventoryByLocationApiDoHWInvByLocationGetAllOpts struct {
	Id           optional.String
...
func (a *HWInventoryByLocationApiService) DoHWInvByLocationGetAll(ctx context.Context, localVarOptionals *HWInventoryByLocationApiDoHWInvByLocationGetAllOpts) ([]HwInventory100HwInventoryByLocation, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	if localVarOptionals != nil && localVarOptionals.Partnumber.IsSet() {
		localVarQueryParams.Add("partnumber", parameterToString(localVarOptionals.Partnumber.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Serialnumber.IsSet() {
		localVarQueryParams.Add("serialnumber", parameterToString(localVarOptionals.Serialnumber.Value(), ""))
	}
...
/*
HWInventoryByLocationApiService Create/Update hardware inventory entries
...
@return Response100
*/
func (a *HWInventoryByLocationApiService) DoHWInvByLocationPost(ctx context.Context, body InventoryHardwareBody) (Response100, *http.Response, error) {
	var (
