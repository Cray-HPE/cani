...
/*
PartitionApiService Delete existing partition with {partition_name}
Delete partition {partition_name}. Any members previously in the partition will no longer have the deleted partition name associated with them.
  ...
  - @param partitionName Partition name of the partition to delete.

@return Response100
*/
func (a *PartitionApiService) DoPartitionDelete(ctx context.Context, partitionName string) (Response100, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/partitions/{partition_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"partition_name"+"}", fmt.Sprintf("%v", partitionName), -1)
...
/*
PartitionApiService Retrieve existing partition {partition_name}
Retrieve the partition which was created with the given {partition_name}.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param partitionName Partition name to be retrieved

@return Partition100
*/
func (a *PartitionApiService) DoPartitionGet(ctx context.Context, partitionName string) (Partition100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Partition100
	)
...
/*
PartitionApiService Delete member from existing partition
Delete component {xname_id} from the members of partition {partition_name}.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param partitionName Existing partition {partition_name} to remove the member from.
  - @param xnameId Member of {partition_name} to remove.

@return Response100
*/
func (a *PartitionApiService) DoPartitionMemberDelete(ctx context.Context, partitionName string, xnameId string) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/partitions/{partition_name}/members/{xname_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"partition_name"+"}", fmt.Sprintf("%v", partitionName), -1)
...
/*
PartitionApiService Retrieve all members of existing partition
Retrieve all members of existing partition {partition_name}, optionally filtering the set, returning a members set that includes the component xname IDs.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param partitionName Existing partition {partition_name} to query the members of.

@return Members100
*/
func (a *PartitionApiService) DoPartitionMembersGet(ctx context.Context, partitionName string) (Members100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/partitions/{partition_name}/members"
	localVarPath = strings.Replace(localVarPath, "{"+"partition_name"+"}", fmt.Sprintf("%v", partitionName), -1)
...
/*
PartitionApiService Create new member of existing partition (via POST)
Create a new member of partition {partition_name} with the component xname ID provided in the payload. New member should not already exist in the given partition
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param partitionName Existing partition {partition_name} to add the new member to.

@return []ResourceUri100
*/
func (a *PartitionApiService) DoPartitionMembersPost(ctx context.Context, body MemberId, partitionName string) ([]ResourceUri100, *http.Response, error) {
	var (
...
/*
PartitionApiService Retrieve all existing partition names
...
@return []string
*/
func (a *PartitionApiService) DoPartitionNamesGet(ctx context.Context) ([]string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/partitions/names"
...
/*
PartitionApiService Update metadata for existing partition {partition_name}
Update the tags array and/or description by using PATCH. Omitted fields are not updated. This cannot be used to completely replace the members list. Rather, individual members can be removed or added with the POST/DELETE {partition_name}/members API.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param partitionName Name of the partition to update.
*/
func (a *PartitionApiService) DoPartitionPatch(ctx context.Context, body Partition100Patch, partitionName string) (*http.Response, error) {
	var (
...
/*
PartitionApiService Retrieve all existing partitions
Retrieve all partitions that currently exist, optionally filtering the set, returning an array of partition records.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PartitionApiDoPartitionsGetOpts - Optional Parameters:
     * @param "Partition" (optional.String) -  Retrieve the partition with the provided partition name (p#.#). Can be repeated to select multiple partitions.
     * @param "Tag" (optional.String) -  Retrieve all partitions associated with the given free-form tag from the tags field.
@return []Partition100
*/

type PartitionApiDoPartitionsGetOpts struct {
	Partition optional.String
	Tag       optional.String
}

func (a *PartitionApiService) DoPartitionsGet(ctx context.Context, localVarOptionals *PartitionApiDoPartitionsGetOpts) ([]Partition100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PartitionApiService Create new partition (via POST)
...
@return []ResourceUri100
*/
func (a *PartitionApiService) DoPartitionsPost(ctx context.Context, body Partition100) ([]ResourceUri100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
