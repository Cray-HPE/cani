...
type DiscoveryStatusApiService service

/*
DiscoveryStatusApiService Retrieve DiscoveryStatus entry matching {id}
Retrieve DiscoveryStatus entry with the specific ID.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id Positive integer ID of DiscoveryStatus entry to retrieve

@return DiscoveryStatus100DiscoveryStatus
*/
func (a *DiscoveryStatusApiService) DoDiscoveryStatusGet(ctx context.Context, id float64) (DiscoveryStatus100DiscoveryStatus, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DiscoveryStatus100DiscoveryStatus
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Inventory/DiscoveryStatus/{id}"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DiscoveryStatus100DiscoveryStatus
...
/*
DiscoveryStatusApiService Retrieve all DiscoveryStatus entries in collection
Retrieve all DiscoveryStatus entries as an unnamed array.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []DiscoveryStatus100DiscoveryStatus
*/
func (a *DiscoveryStatusApiService) DoDiscoveryStatusGetAll(ctx context.Context) ([]DiscoveryStatus100DiscoveryStatus, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Inventory/DiscoveryStatus"
