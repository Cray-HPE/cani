...
/*
CliIgnoreApiService Delete a state change notification subscription
...
*/
func (a *CliIgnoreApiService) DoDeleteSCNSubscription(ctx context.Context, id string) (*http.Response, error) {
	var (
...
/*
CliIgnoreApiService Delete all state change notification subscriptions
Delete all subscriptions.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
*/
func (a *CliIgnoreApiService) DoDeleteSCNSubscriptionsAll(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
CliIgnoreApiService Retrieve a currently-held state change notification subscription
...
*/
func (a *CliIgnoreApiService) DoGetSCNSubscription(ctx context.Context, id string) (SubscriptionsScnPostSubscription, *http.Response, error) {
	var (
...
/*
CliIgnoreApiService Retrieve currently-held state change notification subscriptions
...
*/
func (a *CliIgnoreApiService) DoGetSCNSubscriptionsAll(ctx context.Context) (SubscriptionsScnSubscriptionArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
CliIgnoreApiService Create/Update hardware inventory entries
...
@return Response100
*/
func (a *CliIgnoreApiService) DoHWInvByLocationPost(ctx context.Context, body InventoryHardwareBody) (Response100, *http.Response, error) {
	var (
...
/*
CliIgnoreApiService Update a subscription for state change notifications
Update a subscription for state change notifications to add or remove triggers.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param id This is the ID associated with the subscription that was generated at its creation.
*/
func (a *CliIgnoreApiService) DoPatchSCNSubscription(ctx context.Context, body SubscriptionsScnPatchSubscription, id string) (*http.Response, error) {
	var (
...
/*
CliIgnoreApiService Create a subscription for state change notifications
...
*/
func (a *CliIgnoreApiService) DoPostSCNSubscription(ctx context.Context, body SubscriptionsScnPostSubscription) (SubscriptionsScnSubscriptionArrayItem100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
CliIgnoreApiService Delete all PowerMap entities
Delete all entries in the PowerMaps collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *CliIgnoreApiService) DoPowerMapsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
...
Update an existing state change notification subscription in whole. This will overwrite the specified subscription.
  ...
  - @param id This is the ID associated with the subscription that was generated at its creation.
*/
func (a *CliIgnoreApiService) DoPutSCNSubscription(ctx context.Context, body SubscriptionsScnPostSubscription, id string) (*http.Response, error) {
	var (
...
/*
CliIgnoreApiService Update definition for RedfishEndpoint ID {xname}
...
*/
func (a *CliIgnoreApiService) DoRedfishEndpointPut(ctx context.Context, body RedfishEndpoint100RedfishEndpoint, xname string) (RedfishEndpoint100RedfishEndpoint, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
CliIgnoreApiService Create reservations
...
*/
func (a *CliIgnoreApiService) LocksReservationsPost(ctx context.Context, body AdminReservationCreate100) (AdminReservationCreateResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
CliIgnoreApiService Releases existing reservations.
...
*/
func (a *CliIgnoreApiService) LocksReservationsReleasePost(ctx context.Context, body ReservedKeys100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
CliIgnoreApiService Forcibly deletes existing reservations.
...
@return XnameResponse100
*/
func (a *CliIgnoreApiService) LocksReservationsRemovePost(ctx context.Context, body AdminReservationRemove100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
CliIgnoreApiService Check the validity of reservations.
...
*/
func (a *CliIgnoreApiService) LocksServiceReservationsCheckPost(ctx context.Context, body DeputyKeys100) (ServiceReservationCheckResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *CliIgnoreApiService) LocksServiceReservationsPost(ctx context.Context, body ServiceReservationCreate100) (ServiceReservationCreateResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return XnameResponse100
*/
func (a *CliIgnoreApiService) LocksServiceReservationsReleasePost(ctx context.Context, body ReservedKeys100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
CliIgnoreApiService Renew existing reservations.
...
@return XnameResponse100
*/
func (a *CliIgnoreApiService) LocksServiceReservationsRenewPost(ctx context.Context, body ReservedKeysWithRenewal100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
