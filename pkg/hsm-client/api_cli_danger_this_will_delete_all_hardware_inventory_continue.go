...
type CliDangerThisWillDeleteAllHardwareInventoryContinueApiService service

/*
CliDangerThisWillDeleteAllHardwareInventoryContinueApiService Delete all HWInventoryByLocation entries
...
@return Response100
*/
func (a *CliDangerThisWillDeleteAllHardwareInventoryContinueApiService) DoHWInvByLocationDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
