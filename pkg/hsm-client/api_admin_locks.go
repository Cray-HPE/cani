...
type AdminLocksApiService service

/*
AdminLocksApiService Disables the ability to create a reservation on components.
...
*/
func (a *AdminLocksApiService) LocksDisablePost(ctx context.Context, body AdminLock100) (XnameResponse100, *http.Response, error) {
	var (
...
/*
AdminLocksApiService Locks components.
...
@return XnameResponse100
*/
func (a *AdminLocksApiService) LocksLockPost(ctx context.Context, body AdminLock100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
AdminLocksApiService Repair components lock and reservation ability.
...
@return XnameResponse100
*/
func (a *AdminLocksApiService) LocksRepairPost(ctx context.Context, body AdminLock100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
AdminLocksApiService Retrieve lock status for all components or a filtered subset of components.
Retrieve the status of all component locks and/or reservations. Results can be filtered by query parameters.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AdminLocksApiLocksStatusGetOpts - Optional Parameters:
...
type AdminLocksApiLocksStatusGetOpts struct {
...
func (a *AdminLocksApiService) LocksStatusGet(ctx context.Context, localVarOptionals *AdminLocksApiLocksStatusGetOpts) (AdminStatusCheckResponse100, *http.Response, error) {
	var (
...
/*
AdminLocksApiService Retrieve lock status for component IDs.
...
@return AdminStatusCheckResponse100
*/
func (a *AdminLocksApiService) LocksStatusPost(ctx context.Context, body Xnames) (AdminStatusCheckResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
AdminLocksApiService Unlocks components.
...
@return XnameResponse100
*/
func (a *AdminLocksApiService) LocksUnlockPost(ctx context.Context, body AdminLock100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
