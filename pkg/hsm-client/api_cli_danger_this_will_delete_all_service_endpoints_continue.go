...
type CliDangerThisWillDeleteAllServiceEndpointsContinueApiService service

/*
CliDangerThisWillDeleteAllServiceEndpointsContinueApiService Delete all ServiceEndpoints
Delete all entries in the ServiceEndpoint collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *CliDangerThisWillDeleteAllServiceEndpointsContinueApiService) DoServiceEndpointsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
