...
type CliDangerThisWillDeleteAllComponentEndpointsContinueApiService service

/*
CliDangerThisWillDeleteAllComponentEndpointsContinueApiService Delete all ComponentEndpoints
Delete all entries in the ComponentEndpoint collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *CliDangerThisWillDeleteAllComponentEndpointsContinueApiService) DoComponentEndpointsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
