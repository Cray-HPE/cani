...
/*
MembershipApiService Retrieve membership for component {xname}
Display group labels and partition names for a given component xname ID.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Component xname ID (i.e. locational identifier)

@return Membership100
*/
func (a *MembershipApiService) DoMembershipGet(ctx context.Context, xname string) (Membership100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Membership100
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/memberships/{xname}"
...
/*
MembershipApiService Retrieve all memberships for components
Display group labels and partition names for each component xname ID (where applicable).
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MembershipApiDoMembershipsGetOpts - Optional Parameters:
...
type MembershipApiDoMembershipsGetOpts struct {
	Id             optional.String
...
func (a *MembershipApiService) DoMembershipsGet(ctx context.Context, localVarOptionals *MembershipApiDoMembershipsGetOpts) ([]Membership100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/memberships"
