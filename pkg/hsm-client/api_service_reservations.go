...
type ServiceReservationsApiService service

/*
ServiceReservationsApiService Check the validity of reservations.
...
*/
func (a *ServiceReservationsApiService) LocksServiceReservationsCheckPost(ctx context.Context, body DeputyKeys100) (ServiceReservationCheckResponse100, *http.Response, error) {
	var (
...
/*
ServiceReservationsApiService Create reservations
...
*/
func (a *ServiceReservationsApiService) LocksServiceReservationsPost(ctx context.Context, body ServiceReservationCreate100) (ServiceReservationCreateResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ServiceReservationsApiService Releases existing reservations.
...
*/
func (a *ServiceReservationsApiService) LocksServiceReservationsReleasePost(ctx context.Context, body ReservedKeys100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ServiceReservationsApiService Renew existing reservations.
...
@return XnameResponse100
*/
func (a *ServiceReservationsApiService) LocksServiceReservationsRenewPost(ctx context.Context, body ReservedKeysWithRenewal100) (XnameResponse100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
