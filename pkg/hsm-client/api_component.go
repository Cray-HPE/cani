...
/*
ComponentApiService Update multiple components&#x27; NIDs via ComponentArray
Modify the submitted ComponentArray and update the corresponding NID value for each entry. Other fields are ignored and not changed. ID field is required for all entries.
  ...
  - @param body
*/
func (a *ComponentApiService) DoCompArrayNIDPatch(ctx context.Context, body ComponentArrayPatchArrayNid) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/State/Components/BulkNID"
...
/*
ComponentApiService Update multiple components&#x27; Enabled values via a list of xnames
Update the Enabled field for a list of xnames. Specify a single value for Enabled and also the list of xnames. Note that Enabled is a boolean field and a value of false sets the component(s) to disabled.
  ...
  - @param body
*/
func (a *ComponentApiService) DoCompBulkEnabledPatch(ctx context.Context, body ComponentArrayPatchArrayEnabled) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/BulkEnabled"
...
/*
ComponentApiService Update multiple components&#x27; Flag values via a list of xnames
Specify a list of xnames to update the Flag field and specify the value. The list of IDs and the new Flag are required.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
*/
func (a *ComponentApiService) DoCompBulkFlagOnlyPatch(ctx context.Context, body ComponentArrayPatchArrayFlagOnly) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/BulkFlagOnly"
...
/*
ComponentApiService Update multiple components&#x27; Role values via a list of xnames
Update the Role and SubRole field for a list of xnames. Specify the Role and Subrole values and the list of xnames. The list of IDs and the new Role are required.
  ...
  - @param body
*/
func (a *ComponentApiService) DoCompBulkRolePatch(ctx context.Context, body ComponentArrayPatchArrayRole) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/BulkRole"
...
/*
ComponentApiService Update multiple components&#x27; state data via a list of xnames
Specify a list of xnames to update the State and Flag fields. If the Flag field is omitted, Flag is reverted to &#x27;OK&#x27;. Other fields are ignored. The list of IDs and the new State are required.
  ...
  - @param body
*/
func (a *ComponentApiService) DoCompBulkStateDataPatch(ctx context.Context, body ComponentArrayPatchArrayStateData) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/BulkStateData"
...
/*
ComponentApiService Update multiple components&#x27; SoftwareStatus values via a list of xnames
Update the SoftwareStatus field for a list of xnames. Specify a single new value of SoftwareStatus like admindown and the list of xnames.
  ...
  - @param body
*/
func (a *ComponentApiService) DoCompBulkSwStatusPatch(ctx context.Context, body ComponentArrayPatchArraySoftwareStatus) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/BulkSoftwareStatus"
...
/*
ComponentApiService Update component Enabled value at {xname}
Update the component&#x27;s Enabled field only. The State and other fields are not modified. Note that this is a boolean field, a value of false sets the component to disabled.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of component to set Enabled to true or false.
*/
func (a *ComponentApiService) DoCompEnabledPatch(ctx context.Context, body Component100PatchEnabled, xname string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/{xname}/Enabled"
...
/*
ComponentApiService Update component Flag value at {xname}
The State is not modified. Only the Flag is updated.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of component to modify flag on.
*/
func (a *ComponentApiService) DoCompFlagOnlyPatch(ctx context.Context, body Component100PatchFlagOnly, xname string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/{xname}/FlagOnly"
	localVarPath = strings.Replace(localVarPath, "{"+"xname"+"}", fmt.Sprintf("%v", xname), -1)
...
/*
ComponentApiService Update component NID value at {xname}
Update the component&#x27;s NID field only. Valid only for nodes. State and other fields are not modified.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of component to modify NID on.
*/
func (a *ComponentApiService) DoCompNIDPatch(ctx context.Context, body Component100PatchNid, xname string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/{xname}/NID"
	localVarPath = strings.Replace(localVarPath, "{"+"xname"+"}", fmt.Sprintf("%v", xname), -1)
...
/*
ComponentApiService Update component Role and SubRole values at {xname}
Update the component&#x27;s Role and SubRole fields only. Valid only for nodes. The State and other fields are not modified.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of component to modify Role on.
*/
func (a *ComponentApiService) DoCompRolePatch(ctx context.Context, body Component100PatchRole, xname string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/{xname}/Role"
	localVarPath = strings.Replace(localVarPath, "{"+"xname"+"}", fmt.Sprintf("%v", xname), -1)
...
/*
ComponentApiService Update component state data at {xname}
Update the component&#x27;s state and flag fields only. If Flag field is omitted, the Flag value is reverted to &#x27;OK&#x27;.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of component to set state/flag on.
*/
func (a *ComponentApiService) DoCompStatePatch(ctx context.Context, body Component100PatchStateData, xname string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/{xname}/StateData"
	localVarPath = strings.Replace(localVarPath, "{"+"xname"+"}", fmt.Sprintf("%v", xname), -1)
...
/*
ComponentApiService Update component SoftwareStatus value at {xname}
Update the component&#x27;s SoftwareStatus field only. The State and other fields are not modified.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of component to set new SoftwareStatus value.
*/
func (a *ComponentApiService) DoCompSwStatusPatch(ctx context.Context, body Component100PatchSoftwareStatus, xname string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/{xname}/SoftwareStatus"
	localVarPath = strings.Replace(localVarPath, "{"+"xname"+"}", fmt.Sprintf("%v", xname), -1)
...
/*
ComponentApiService Retrieve component with NID&#x3D;{nid}
Retrieve a component by NID.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param nid NID of component to return.

@return Component100Component
*/
func (a *ComponentApiService) DoComponentByNIDGet(ctx context.Context, nid string) (Component100Component, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue Component100Component
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/ByNID/{nid}"
	localVarPath = strings.Replace(localVarPath, "{"+"nid"+"}", fmt.Sprintf("%v", nid), -1)
...
/*
ComponentApiService Create component query (by NID ranges), returning ComponentArray
Retrieve the targeted entries in the form of a ComponentArray by providing a payload of NID ranges.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body

@return ComponentArrayComponentArray
*/
func (a *ComponentApiService) DoComponentByNIDQueryPost(ctx context.Context, body ComponentArrayPostByNidQuery) (ComponentArrayComponentArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ComponentArrayComponentArray
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/ByNID/Query"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ComponentArrayComponentArray
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ComponentApiService Delete component with ID {xname}
Delete a component by xname.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of component record to delete.

@return Response100
*/
func (a *ComponentApiService) DoComponentDelete(ctx context.Context, xname string) (Response100, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/{xname}"
	localVarPath = strings.Replace(localVarPath, "{"+"xname"+"}", fmt.Sprintf("%v", xname), -1)
...
/*
ComponentApiService Retrieve component at {xname}
Retrieve state or components by xname.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param xname Locational xname of component to return.

@return Component100Component
*/
func (a *ComponentApiService) DoComponentGet(ctx context.Context, xname string) (Component100Component, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ComponentApiService Create/Update an HMS Component
Create/Update a state/component. If the component already exists it will not be overwritten unless force&#x3D;true in which case State, Flag, Subtype, NetType, Arch, and Class will get overwritten.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body
  - @param xname Locational xname of the component to create or update.
*/
func (a *ComponentApiService) DoComponentPut(ctx context.Context, body Component100Put, xname string) (*http.Response, error) {
	var (
...
/*
ComponentApiService Retrieve component query for {xname}, returning ComponentArray
Retrieve component entries in the form of a ComponentArray by providing xname and modifiers in the query string.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xname Locational xname of component to query.
 * @param optional nil or *ComponentApiDoComponentQueryGetOpts - Optional Parameters:
     * @param "Type_" (optional.String) -  Retrieve xname&#x27;s children of type&#x3D;{type} instead of {xname} for example NodeBMC, NodeEnclosure etc.
     * @param "State" (optional.String) -  Filter the results based on HMS state like Ready, On etc. Can be specified multiple times for selecting entries in different states.
     * @param "Flag" (optional.String) -  Filter the results based on HMS flag value like OK, Alert etc. Can be specified multiple times for selecting entries with different flags.
     * @param "Role" (optional.String) -  Filter the results based on HMS role. Can be specified multiple times for selecting entries with different roles. Valid values are: - Compute - Service - System - Application - Storage - Management Additional valid values may be added via configuration file. See the results of &#x27;GET /service/values/role&#x27; for the complete list.
     * @param "Subrole" (optional.String) -  Filter the results based on HMS subrole. Can be specified multiple times for selecting entries with different subroles. Valid values are: - Master - Worker - Storage Additional valid values may be added via configuration file. See the results of &#x27;GET /service/values/subrole&#x27; for the complete list.
     * @param "Enabled" (optional.String) -  Filter the results based on enabled status (true or false).
     * @param "Softwarestatus" (optional.String) -  Filter the results based on software status. Software status is a free form string. Matching is case-insensitive. Can be specified multiple times for selecting entries with different software statuses.
     * @param "Subtype" (optional.String) -  Filter the results based on HMS subtype. Can be specified multiple times for selecting entries with different subtypes.
     * @param "Arch" (optional.String) -  Filter the results based on architecture. Can be specified multiple times for selecting components with different architectures.
     * @param "Class" (optional.String) -  Filter the results based on HMS hardware class. Can be specified multiple times for selecting entries with different classes.
     * @param "Nid" (optional.String) -  Filter the results based on NID. Can be specified multiple times for selecting entries with multiple specific NIDs.
     * @param "NidStart" (optional.String) -  Filter the results based on NIDs equal to or greater than the provided integer.
     * @param "NidEnd" (optional.String) -  Filter the results based on NIDs less than or equal to the provided integer.
     * @param "Partition" (optional.String) -  Restrict search to the given partition (p#.#). One partition can be combined with at most one group argument which will be treated as a logical AND. NULL will return components in NO partition.
     * @param "Group" (optional.String) -  Restrict search to the given group label. One group can be combined with at most one partition argument which will be treated as a logical AND. NULL will return components in NO groups.
     * @param "Stateonly" (optional.Bool) -  Return only component state and flag fields (plus xname/ID and type). Results can be modified and used for bulk state/flag- only patch operations.
     * @param "Flagonly" (optional.Bool) -  Return only component flag field (plus xname/ID and type). Results can be modified and used for bulk flag-only patch operations.
     * @param "Roleonly" (optional.Bool) -  Return only component role and subrole fields (plus xname/ID and type). Results can be modified and used for bulk role-only patches.
     * @param "Nidonly" (optional.Bool) -  Return only component NID field (plus xname/ID and type). Results can be modified and used for bulk NID-only patches.
@return ComponentArrayComponentArray
*/

type ComponentApiDoComponentQueryGetOpts struct {
	...
	Softwarestatus optional.String
	Subtype        optional.String
	Arch           optional.String
	Class          optional.String
	Nid            optional.String
	NidStart       optional.String
	NidEnd         optional.String
	Partition      optional.String
	Group          optional.String
	Stateonly      optional.Bool
	Flagonly       optional.Bool
	Roleonly       optional.Bool
	Nidonly        optional.Bool
}

func (a *ComponentApiService) DoComponentQueryGet(ctx context.Context, xname string, localVarOptionals *ComponentApiDoComponentQueryGetOpts) (ComponentArrayComponentArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/Query/{xname}"
	localVarPath = strings.Replace(localVarPath, "{"+"xname"+"}", fmt.Sprintf("%v", xname), -1)
	...
	if localVarOptionals != nil && localVarOptionals.Subrole.IsSet() {
		localVarQueryParams.Add("subrole", parameterToString(localVarOptionals.Subrole.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.Softwarestatus.IsSet() {
		localVarQueryParams.Add("softwarestatus", parameterToString(localVarOptionals.Softwarestatus.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.Nid.IsSet() {
		localVarQueryParams.Add("nid", parameterToString(localVarOptionals.Nid.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.NidStart.IsSet() {
		localVarQueryParams.Add("nid_start", parameterToString(localVarOptionals.NidStart.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.NidEnd.IsSet() {
		localVarQueryParams.Add("nid_end", parameterToString(localVarOptionals.NidEnd.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Partition.IsSet() {
		localVarQueryParams.Add("partition", parameterToString(localVarOptionals.Partition.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.Stateonly.IsSet() {
		localVarQueryParams.Add("stateonly", parameterToString(localVarOptionals.Stateonly.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Flagonly.IsSet() {
		localVarQueryParams.Add("flagonly", parameterToString(localVarOptionals.Flagonly.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Roleonly.IsSet() {
		localVarQueryParams.Add("roleonly", parameterToString(localVarOptionals.Roleonly.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Nidonly.IsSet() {
		localVarQueryParams.Add("nidonly", parameterToString(localVarOptionals.Nidonly.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
ComponentApiService Delete all components
Delete all entries in the components collection.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return Response100
*/
func (a *ComponentApiService) DoComponentsDeleteAll(ctx context.Context) (Response100, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components"
...
/*
ComponentApiService Retrieve collection of HMS Components
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ComponentApiDoComponentsGetOpts - Optional Parameters:
...
type ComponentApiDoComponentsGetOpts struct {
	Id             optional.String
	Type_          optional.String
	State          optional.String
	Flag           optional.String
...
func (a *ComponentApiService) DoComponentsGet(ctx context.Context, localVarOptionals *ComponentApiDoComponentsGetOpts) (ComponentArrayComponentArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ComponentApiService Create/Update a collection of HMS Components
Create/Update a collection of state/components. If the component already exists it will not be overwritten unless force&#x3D;true in which case State, Flag, Subtype, NetType, Arch, and Class will get overwritten.
  ...
  - @param body
*/
func (a *ComponentApiService) DoComponentsPost(ctx context.Context, body ComponentArrayPostArray) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ComponentApiService Create component query (by xname list), returning ComponentArray
...
@return ComponentArrayComponentArray
*/
func (a *ComponentApiService) DoComponentsQueryPost(ctx context.Context, body ComponentArrayPostQuery) (ComponentArrayComponentArray, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/State/Components/Query"
